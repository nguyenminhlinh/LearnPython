...
def phonebook():
    contacts = []
    open("D:\\OneDrive - zb87w\\STUDY\\Tuhoc\\Python\\LearnPython\\Chuong_11\\Contact.txt", "w")
    while True:
        entry = welcome()
        if entry == 1:
            f = open("D:\\OneDrive - zb87w\\STUDY\\Tuhoc\\Python\\LearnPython\\Chuong_11\\Contact.txt", "r")
            ...
            for i in contacts:
                if i.find(contact_name) != -1:
                    ...
                    break
            if checked == False:
                f = open("D:\\OneDrive - zb87w\\STUDY\\Tuhoc\\Python\\LearnPython\\Chuong_11\\Contact.txt", "a")
            ...
            for i in contacts:
                if i.find(name) != -1:
                    ...
                    if confirm.capitalize() == "Y":
                        ...
                        f = open("D:\\OneDrive - zb87w\\STUDY\\Tuhoc\\Python\\LearnPython\\Chuong_11\\Contact.txt", "w")
                        for i in contacts:
                            f.write(i)
                        f.close()
                    else:
